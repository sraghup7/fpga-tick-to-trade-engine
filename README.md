...
make synth        # real Vivado synth+impl via scripts/build.tcl (non-project mode) -- now
                  # closes timing (WNS +0.141 ns, WHS +0.043 ns, 0 latches)
